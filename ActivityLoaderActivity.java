...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent myExplicitIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
		// DONE - Start an Activity using that intent and the request code defined above
		ActivityLoaderActivity.this.startActivityForResult(myExplicitIntent,GET_TEXT_REQUEST_CODE);
	}
